...
class SVGHandler
 {
    static function displayDiagram(\OmniFlow\BPMN\Process $proc,$decorations)
    {
            ...
            if (strpos($entries,'Generated by the Batik Graphics2D SVG Generator')!== false) 
            {	// eclipse style
                    $generator="eclipse";
            }
            elseif (strpos($entries,'created with bpmn-js')!== false)
            {	// bpmn-js style
                    $generator="bpmn.js";
            }	
            ...
            if ($generator=='eclipse')
            {
                Context::Log(INFO, "eclipse diagram");
                    ...
                    foreach($g as $rect)
                    {
                            ...
                            $rects[]=array($rect,$gx,$gy,$gw,$gh,null);	
